...
def Bad_Ending_for_i(posible_actions: list[list[Kingdom]], i: int)-> int:
    '''
    Return the index of the worst ending for the kingdom i
    '''
...
def Strongest_Army(Kingdoms: list[Kingdom], my_index: int) -> int:
    '''
    Return the index of the kingdom with the strongest army (if my_index = -1 includes all the kingdoms in the comparison)
    '''
